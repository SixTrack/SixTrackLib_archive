...
class RPNparser(object):
  ...
  encode_opr={'+':3,'-':6,'=':9,'*':12,'/':15,'^':18}

  op_associativity = {op_pow: "right", op_mul: "left", op_div: "left", op_add: "left", op_sub: "left", op_equ: "left"}

  op_precedence = {op_pow: 4, op_mul: 3, op_div: 3, op_add: 2, op_sub: 2, op_equ: 1, op_left: -1, op_right: -1}
...
seq.add_count("cnt",1,100)
seq.add_expr("exp1","rot1.angle","0.245+cnt.count*0.00001")
