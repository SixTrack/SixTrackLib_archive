...
int cntexactdrift4d = 0;
extern int thin4d_map_exact_drift_(double *coord, double *argf, double *argi)
{
    double x = coord[0], y = coord[1];
    double xp = coord[2], yp = coord[3];
...
int cnthordipole = 0;
extern int map_horizontal_dipole_(double *coord, double *argf, double *argi)
{
    double xp = coord[2],yp = coord[3];
    double RatioPtoPj = coord[4];
...
#define make_map_normal_pole(NAME,i)                                                                                       \
  int cntnorm##NAME = 0;                                                                                                   \
  extern int map_normal_##NAME##_(double *coord, double *argf, double *argi) {                                      \
    double x = coord[0], y = coord[1];                                                                                     \
    double xp = coord[2],yp = coord[3];                                                                                    \
    double RatioPtoPj = coord[4];                                                                                          \
                                                                                                                           \
...
int cntverdip = 0;
extern int map_vertical_dipole_(double *coord, double *argf, double *argi)
{
    double xp = coord[2],yp = coord[3];
    double RatioPtoPj = coord[4];
...
#define make_map_skew_pole(NAME,i)                                                                                       \
  int cntskew##NAME = 0;                                                                                                   \
  extern int map_skew_##NAME##_(double *coord, double *argf, double *argi) {                                      \
    double x = coord[0], y = coord[1];                                                                                     \
    double xp = coord[2],yp = coord[3];                                                                                    \
    double RatioPtoPj = coord[4];                                                                                          \
                                                                                                                           \
...
#define make_map_crab_cavity( I, C )                                                                                   \
  ...
  extern int map_crab_cavity_##I##_(double *coord, double *argf, double *argi) {                                \
    double x = coord[0], y = coord[1];                                                                                 \
    double xp = coord[2], yp = coord[3];                                                                               \
    double RatioPtoPj = coord[4];                                                                                      \
    double PathLengthDiff = coord[5];                                                                                  \
...
int cntdipedge = 0;
extern int map_dipedge_(double *coord, double *argf, double *argi)
{
    double x = coord[0], y = coord[1];
    double xp = coord[2], yp = coord[3];
    double RatioPtoPj = coord[4];
...
int cntacdipole = 0;
extern int map_ac_dipole_(double *coord, double *argf, double *argi)
{
    double xp = coord[2], yp = coord[3];
...
int cntwire = 0;
extern int map_wire_(double *coord, double *argf, double *argi)
{
    double x = coord[0], y = coord[1];
    double xp = coord[2], yp = coord[3];
    double RatioDeltaPtoPj = coord[8];
...
int cntbb1 = 0;
extern int map_beambeam_type1_( double *coord, double *argf, double argi )
{
    double x = coord[0], y = coord[1];
    double xp = coord[2], yp = coord[3];
    double RatioPtoPj = coord[4];
...
extern int map_beambeam_type2_( double *coord, double *argf, double *argi )
{
    double x = coord[0], y = coord[1];
    double xp = coord[2], yp = coord[3];
    double RatioPtoPj = coord[4];
...
extern int map_beambeam_type3_( double *coord, double *argf, double *argi )
{
    double x = coord[0], y = coord[1];
    double xp = coord[2], yp = coord[3];
    double RatioPtoPj = coord[4];
